  ...
  memoizeeMethods({
      ...
      async function () {
        ...
        try {
          ...
          throw new this.serverless.classes.Error(
            'Could not find Docker installation. Ensure Docker is installed on your machine before continuing.'
          );
        }
        ...
        try {
          ...
          process.stdin.write(dockerLoginPromise.stdBuffer);
        } catch (err) {
          throw new this.serverless.classes.Error(
    ...
    resolveImageUriAndSha: d(
      ...
      async function (image) {
        ...
        if (!isDockerUri(image)) {
          throw new this.serverless.classes.Error(
            `Referenced "${image}" not defined in "provider.docker.images"`
          );
        }
